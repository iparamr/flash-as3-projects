package {
	...
	public class HorseWidget extends Sprite {
		private const FADE_OUT_STEP:Number = 0.05;
		private const INITIAL_ANGLE:Number = -Math.PI / 2;
		private const SPEED:Number = 0.2;
		private const RANGE:int = 50;

		private var channel:SoundChannel = new SoundChannel();
		private var angle:Number = INITIAL_ANGLE;
		...
		private function fadeOutSound(e:Event):void {
			...
			if (transform.volume > 0) {
				...
				transform.volume -= FADE_OUT_STEP;
		...
		private function defineAssets():void {
